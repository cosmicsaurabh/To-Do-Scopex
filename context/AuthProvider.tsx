...
export const AuthProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ user, signin,googleSignIn,googleSignUp, phoneSignIn, verifyOtp, signup, logout, isLoggedIn, isLoading,deleteuser }}>
      {children}
...
//         throw new Error('ID token is missing');
//       }
//       console.log("after idtoek");
      
//       console.log("idtokem  ", userInfo.data?.idToken);
//       const googleCredential = auth.GoogleAuthProvider.credential(userInfo.data?.idToken);
...
//       setIsLoggedIn(true);
//       await AsyncStorage.setItem('currentUser', JSON.stringify(currentUser?.email));
//       return true;
//     } catch (error) {
//       console.error('Error with Google Sign-In:', JSON.stringify(error));
//       return false;
//     }
//   };
...
//   return (
//     <AuthContext.Provider value={{ user, signin,googleSignIn, phoneSignIn, verifyOtp, signup, logout, isLoggedIn, isLoading,deleteuser }}>
//       {children}
//     </AuthContext.Provider>
//   );
// };
